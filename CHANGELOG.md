...
### Fixed
* Fixed arithmetic overflow error causing Ultimining to fail if player has >=15466 levels
  * Note that this many levels can be problematic for other mods too due to vanilla using a 32-bit int to track player total XP

## [2101.1.14]

### Fixed
* Better client/server API method handling
  * Fixes issues with FTB Unearthed and brushing with ultimine for players on LAN worlds
