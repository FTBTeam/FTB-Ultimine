...
### Fixed
* Fixed issues with selection of flower-type blocks introduced in last release
  * Technically, any blocks which extend `BushBlock` but which are not crops (e.g. Botania flowers)
